...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1ETICIL5hdjXR14fb_Mvp2igeY9mg_7hwcWf-UfRCStI#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1ETICIL5hdjXR14fb_Mvp2igeY9mg_7hwcWf-UfRCStI', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/idp_georgia/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```

...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.simpleSessionStorage = factory();
    }
    ...
    function _init() {
        ...
        // This is intentional
        window.sessionStorage.setItem('__simpleSessionStorageTest', 'tmpval');
        window.sessionStorage.removeItem('__simpleSessionStorageTest');
    ...
    function _load_storage() {
        var source = sessionStorage.getItem('simpleSessionStorage');
    ...
    function _save() {
        try {
            sessionStorage.setItem('simpleSessionStorage',
    ...
    return {
        ...
        set: function(key, value, options) {
            if (key == '__simpleSessionStorage_meta') {
                return false;
            }
        ...
        get: function(key) {
            ...
            if (_storage.hasOwnProperty(key) && key != '__simpleSessionStorage_meta') {
        ...
        flush: function() {
            ...
            _storage = {};
            try {
                sessionStorage.removeItem('simpleSessionStorage');
                return true;
            } catch (E) {
                return E;
            }
        ...
        index: function() {
            ...
            var index = [],
                i;
            for (i in _storage) {
                if (_storage.hasOwnProperty(i) && i != '__simpleSessionStorage_meta') {
                    index.push(i);
                }
            }
            return index;
